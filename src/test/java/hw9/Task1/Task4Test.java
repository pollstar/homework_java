...
public class Task4Test {
    ...
    void replacingEvenNumbersOnZero_OddNotIsZero() {
        System.out.print("Testing replacingEvenNumbersOnZero_OddNotIsZero: ");
    ...
    void replacingEvenNumbersOnZero_EvenIsZero() {
        System.out.print("Testing replacingEvenNumbersOnZero_EvenIsZero: ");
        Assertions.assertAll("arrayResult",
    ...
    void replacingEvenNumbersOnZero_LengthArrayControl() {
        System.out.print("Testing replacingEvenNumbersOnZero_LengthArrayControl: ");
